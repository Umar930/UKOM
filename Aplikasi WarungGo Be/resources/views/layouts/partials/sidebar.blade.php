<div class="flex h-full flex-col">
    ...
    <div class="flex h-16 shrink-0 items-center gap-3 px-6 border-b border-gray-200">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-900">WarungGo</h1>
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto scrollbar-thin">
        ...
        <a href="{{ route('transactions') }}" class="sidebar-link {{ request()->routeIs('transactions') ? 'active' : '' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p class="px-4 pt-6 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Pengaturan</p>
    ...
    <div class="border-t border-gray-200 p-4">
        <div class="flex items-center gap-3 px-2">
            <x-avatar alt="Admin User" size="md" status="online" />
            <div class="flex-1 min-w-0">
                <p class="text-sm font-medium text-gray-900 truncate">Admin User</p>
                <p class="text-xs text-gray-500 truncate">admin@warunggo.com</p>
            </div>
